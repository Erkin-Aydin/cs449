...
goal_area1(floorwalls): { shape: box, size: [2, 1, 0.01], color: [0, 0, 1], Q: [0, -2.5, 0.03, 1, 0, 0, 0] ,contact: -2}
goal_area2(floorwalls): { shape: box, size: [2, 1, 0.01], color: [0, 0, 1], Q: [4.0, -2.0, 0.03, 1, 0, 0, 0] ,contact: -2}
goal_area3(floorwalls): { shape: box, size: [2, 1, 0.01], color: [0, 0, 1], Q: [4.0, 0.0, 0.03, 1, 0, 0, 0] ,contact: -2}
goal_area4(floorwalls): { shape: box, size: [2, 1, 0.01], color: [0, 0, 1], Q: [4.0, 3.5, 0.03, 1, 0, 0, 0] ,contact: -2}