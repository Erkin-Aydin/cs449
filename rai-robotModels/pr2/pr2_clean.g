...
fl_caster_rotation_joint(fl_caster_rotation_joint_origin): { joint: hingeZ, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] } ################################333
fr_caster_rotation_joint(fr_caster_rotation_joint_origin): { joint: hingeZ, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
bl_caster_rotation_joint(bl_caster_rotation_joint_origin): { joint: hingeZ, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
br_caster_rotation_joint(br_caster_rotation_joint_origin): { joint: hingeZ, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
...
fl_caster_l_wheel_joint(fl_caster_l_wheel_joint_origin): { joint: hingeY, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] } ##########################################33
fl_caster_r_wheel_joint(fl_caster_r_wheel_joint_origin): { joint: hingeY, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
fr_caster_l_wheel_joint(fr_caster_l_wheel_joint_origin): { joint: hingeY, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
fr_caster_r_wheel_joint(fr_caster_r_wheel_joint_origin): { joint: hingeY, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
bl_caster_l_wheel_joint(bl_caster_l_wheel_joint_origin): { joint: hingeY, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
bl_caster_r_wheel_joint(bl_caster_r_wheel_joint_origin): { joint: hingeY, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
br_caster_l_wheel_joint(br_caster_l_wheel_joint_origin): { joint: hingeY, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
br_caster_r_wheel_joint(br_caster_r_wheel_joint_origin): { joint: hingeY, limits: [0, 100, 0, 100, -1, 100], ctrl_limits: [100, -1, 100] }
...
r_forearm_roll_joint(r_elbow_flex_link): { joint: hingeX, limits: [0, 100, 0, 3.6, -1, 30], ctrl_limits: [3.6, -1, 30] }		#This######################################################3
l_forearm_roll_joint(l_elbow_flex_link): { joint: hingeX, limits: [0, 100, 0, 3.6, -1, 30], ctrl_limits: [3.6, -1, 30] }
...
r_wrist_roll_joint(r_wrist_flex_link): { joint: hingeX, limits: [0, 100, 0, 3.6, -1, 10], ctrl_limits: [3.6, -1, 10] }  #This#####################################################################33
l_wrist_roll_joint(l_wrist_flex_link): { joint: hingeX, limits: [0, 100, 0, 3.6, -1, 10], ctrl_limits: [3.6, -1, 10] }  #This
