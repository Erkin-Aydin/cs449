...
#Checkpoint-1
cp1(floorwalls): { shape: box, size: [2, 1, 0.01], color: [0, 1, 0,0.2], Q: [0, -2, 0.53, 0, 0, 0.7071068, 0.7071068 ] ,contact: 0}

#Checkpoint-2
cp2(floorwalls): { shape: box, size: [2, 1, 0.01], color: [0, 1, 0,0.2], Q: [4, -2, 0.53, 0, 0, 0.7071068, 0.7071068] ,contact: 0}

#Checkpoint-3
cp3(floorwalls): { shape: box, size: [0.02, 2, 2.01], color: [0, 1, 0,0.2], Q: [3, 3, 0.03, 1, 0, 0, 0] ,contact: 0}

#Checkpoint-4
cp4(floorwalls): { shape: box, size: [2, 1, 0.01], color: [0, 1, 0,0.2], Q: [-2, 2, 0.53, 0, 0, 0.7071068, 0.7071068 ] ,contact: 0}
